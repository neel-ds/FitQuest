        ...
        <div className="md:text-left flex justify-center flex-row">
          <div className="flex flex-col justify-center">
            <h1 className="text-4xl tracking-tight font-extrabold text-gray-900 sm:text-5xl md:text-6xl">
              <span className="block xl:inline text-4xl pb-2 text-[#E3FED8]">Unleash your potential with</span>
              <span className="block text-transparent bg-clip-text bg-gradient-to-r from-[#35B226] to-[#08EA70] pb-4">
              FitQuest
              </span>
            ...
            <p className="mt-3 text-base text-[#E3FED8] sm:mt-5 sm:text-lg sm:max-w-xl sm:mx-auto md:mt-5 md:text-xl lg:mx-0">
              Encourage your fitness goals with ultimate rewards and subscribe our plans to smash the new records.
            </p>
            <div className="mt-5 sm:mt-8 sm:flex lg:justify-start md:flex-col lg:flex-row">
              <div>
                <Link href="/plans" className="w-full md:w-[70%] lg:w-full flex items-center justify-center px-8 py-3 border-0 border-transparent text-base font-medium rounded-xl text-white bg-gradient-to-r from-[#08EA70] to-[#35B226] hover:drop-shadow-[0_1px_2px_#08EA70] md:py-2 md:text-lg md:px-8"
                  >Explore</Link>
              </div>
            </div>
          </div>
