...
contract Silver is ERC721 {
    ...
    function mint() public returns (uint256) {
        require(
            _mintedTokens[msg.sender] < _maxMintLimit,
            "You have already minted the maximum number of tokens"
        );
        ...
        returns (string memory)
    {
        ...
        string
            memory baseURI = "https://bafkreihtyhdaz6ooonoeoozu4txgrsvqbajvkgvsskxaw3belazroqkngi.ipfs.nftstorage.link";
